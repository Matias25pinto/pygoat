    ...
    stages {
        ...
        with open('../$BOM_FILE', 'w') as f:
            json.dump(bom, f, indent=2)
                    ...
                    // 3️⃣ Obtener información del proyecto (intento simple) - CORREGIDO
                    sh '''
                        ...
                        # CORRECCIÓN: Usar formato de concatenación en lugar de interpolación con \
                        echo "$PROJECTS_JSON" | jq -r '.[] | "  - " + .name + ": " + (.lastBomImport // "N/A")' 2>/dev/null || echo "  No se pudieron listar proyectos"
